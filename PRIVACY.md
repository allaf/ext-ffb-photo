...
- l’identifiant et le mot de passe FFBoxe saisis par l’utilisateur ;
...
Les identifiants FFBoxe sont transmis uniquement à
`https://extranet.ffboxe.com` afin d’ouvrir la session demandée par
l’utilisateur.
...
Les paramètres de connexion sont enregistrés localement dans le profil Firefox
avec l’API de stockage de Firefox. Ils ne sont pas chiffrés par l’extension.
